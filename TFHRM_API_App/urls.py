...
from QuizApp.views import QuestionAnswerSetView, SubmittedAnswerView, SubmittedAnswerListView, \
    FilterQuestionView, FilterQuestionListView, FilterQuestionUpdateDeleteView
...
from AdminOperationApp.views import AppliedUserDetailsView, AdminJobListView, OnlineTestLinkView, \
    ...
    DocumentVerifiedView, DocumentRequestView
...
urlpatterns = [
    ...
    path('documents_request/<id>/', DocumentRequestView.as_view(), name='document_request'),
