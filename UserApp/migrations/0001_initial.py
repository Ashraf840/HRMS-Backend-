    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', django_resized.forms.ResizedImageField(crop=None, force_format='JPEG', help_text='Size Recommended: 512x512', keep_meta=True, quality=100, size=[512, 512], upload_to='users/')),
                ...
                ('email_validated', models.BooleanField(default=False, help_text='Designate if the user has Email Validate', verbose_name='Email Validate')),
                ...
                ('is_candidate', models.BooleanField(default=True, help_text='Designate if the user has Candidate status', verbose_name='candidate Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userSkills', models.ManyToManyField(related_name='user_skills', to='UserApp.SkillsModel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachedFile', models.FileField(blank=True, null=True, upload_to=UserApp.models.content_file_name)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sscCertificate', models.FileField(upload_to=UserApp.models.content_file_name)),
                ('hscCertificate', models.FileField(upload_to=UserApp.models.content_file_name)),
                ('graduationCertificate', models.FileField(upload_to=UserApp.models.content_file_name)),
                ('postGraduationCertificate', models.FileField(blank=True, upload_to=UserApp.models.content_file_name)),
                ('nidCard', models.FileField(blank=True, upload_to=UserApp.models.content_file_name)),
                ('userPassportImage', models.ImageField(upload_to=UserApp.models.image_file_name)),
